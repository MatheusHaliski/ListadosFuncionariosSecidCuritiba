//import SwiftUI
//
//struct RegionalInfo5: Identifiable {
//    let id = UUID()
//    let regional: String
//    let chefe: String
...
//
//    private let dadosRegionais: [RegionalInfo5] = [
//        RegionalInfo5(regional: "Regional 1", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 2", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 3", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 4", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 5", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 1", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 2", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 3", chefe: "Nome do Chefe", ramalRegional: "0000"),
//        RegionalInfo5(regional: "Regional 4", chefe: "Nome do Chefe", ramalRegional: "0000"),
...
//
//    // MARK: ROWS
//    private func rowView(_ info: RegionalInfo5) -> some View {
//        HStack(spacing: columnSpacing) {
//
//            Text(info.nome)
